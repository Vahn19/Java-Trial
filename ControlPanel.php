...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
	...
	$domain = $_POST['command'];
	exec("java -Xmx1g -jar ControlPanel.jar \"$domain\"", $output);
?>
 
<!DOCTYPE html>
<html lang="en">
<head>
	<title>NSP Final Project</title>
...
<img src="main.jpg" class="bg">
	<div class="topnav" id="myTopnav">
	  ...
	  <a href="#ControlPanel" class="active">Control Panel</a>
	...
	<div class="wrapper">
		...
		<br>
		<input type="submit" class="btn btn-primary warna">
	</form>
    </div>    
